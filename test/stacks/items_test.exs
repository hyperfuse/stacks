defmodule Stacks.ItemsTest do
  ...
  describe "items" do
    ...
    test "create_item/1 with valid data creates a item" do
      valid_attrs = %{item_type: "some item_type", metadata: %{}, source_url: "some source_url", text_content: "some text_content", title: "some title"}
    ...
    test "update_item/2 with valid data updates the item" do
      item = item_fixture()
      update_attrs = %{item_type: "some updated item_type", metadata: %{}, source_url: "some updated source_url", text_content: "some updated text_content", title: "some updated title"}
